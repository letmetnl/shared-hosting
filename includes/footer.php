<body>
    ...
    <footer id="footer" class="site-footer pb-0" style="
padding-top: 21px;">
        <div class="container container-fluid ">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-3 col-md-3 col-sm-12 d-flex align-items-end justify-content-center flex-column ">
                    <div class="footer-section d-flex align-items-center">
                        <a class="navbar-brand" href="/">
                            <svg version="1.0" xmlns="https://www.w3.org/2000/svg" width="100px" height=""
                                viewBox="0 0 934.000000 1155.000000" preserveAspectRatio="xMidYMid meet">

                                <g transform="translate(0.000000,1155.000000) scale(0.100000,-0.100000)" fill="#0080ff"
                                    stroke="none" class="footer-logo">
...
-16 29 -71 68 -120 86 -53 18 -180 19 -239 0z" />
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 footer-force-height d-flex flex-column align-items-center">
            ...
            ">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 footer-force-height d-flex flex-column align-items-center">
                    ...
                    <ul class="footer-list pl-4" style="
                    line-height: 27px;">
                        <li>
                            <p style="
                            font-weight: 600;
        ...
        <hr class="rgba-white-light mt-4" style="margin: 0 10%; padding-bottom: 20px;">
        ...
        ">
                ...
                <div class="mb-5 flex-center">
                    ...
                    <a href="https://www.instagram.com/open_tabs/" class="ins-ic" target="_blank">
                        <i class="fab fa-instagram fa-lg white-text mr-4 hvr-bounce-in footer-icons-hover"> </i>
                    </a>

                    <!--Linkedin -->
                    <a href="https://linkedin.com/company/opentabs-org" class="li-ic" target="_blank">
                        <i class="fab fa-linkedin-in fa-lg white-text mr-4 hvr-bounce-in footer-icons-hover"> </i>
                    </a>


                    <!-- youtube -->
                    <a href="https://www.youtube.com/channel/UC7Ggi0aAxmxHtoMqZ6BckBg" class="tw-ic" target="_blank">
                        <i class="fab fa-youtube fa-lg white-text mr-4 hvr-bounce-in footer-icons-hover"> </i>
                    </a>

                    <!--twitter-->
                    <a href="https://twitter.com/OpenTabs_org" class="tw-ic" target="_blank">
                        <i class="fab fa-twitter fa-lg white-text mr-4 hvr-bounce-in footer-icons-hover"> </i>
                    </a>
                    <!---facebook-->
                    <a href="https://www.facebook.com/opentabs.org" class="tw-ic" target="_blank">
                        <i class="fab fa-facebook fa-lg white-text mr-4 hvr-bounce-in footer-icons-hover"> </i>
                    </a>
